const ja = {
  MY_NAME: "梅本 晴弥",
  BIOGRAPHY:
    "大学/大学院では情報学を専攻し、機械学習や深層学習を用いた研究を行った。研究分野としては強化学習と自然言語処理(NLP)が専門で、最近は画像分野での研究に対する理解も深めている。大学院卒業後はAIベンチャーに入社し、NLPを中心として大規模言語モデルや対話システム等の研究開発を担当した。現職では自身の知識を活かしたAIソリューションの提供を中心に活動しており、その他にAIチームの立ち上げやプロダクト開発にも力を入れている。ML領域だけではなくIT全般に対して興味があり、フロントエンドやバックエンド、クラウド等における技術も持ち合わせている。",
