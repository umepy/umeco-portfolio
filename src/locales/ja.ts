...
const ja = {
  ...
  BIOGRAPHY:
    ...
    研究分野としては強化学習と自然言語処理(NLP)が専門で、直近では画像分野での研究に対する理解も深めている。\
    大学院卒業後はAIベンチャーに入社し、NLPを中心として大規模言語モデルや対話システム等の研究開発を担当。\
    現職では自身の知識を活かしたAIソリューションの提供を中心に活動しており、特に最先端のAI技術を活用した研究開発の支援を得意とする。\
    その他、AIチームの立ち上げやプロダクト開発にも力を入れている。\
    AI領域だけではなくIT分野全般に対して興味があり、フロントエンドやバックエンド、クラウド等における技術も持ち合わせている。",
  CONTACT:
    "直近では生成AIプロジェクトの立ち上げやコンサルティング等をAI顧問という形でご支援をさせて頂いております。\
  ご依頼等は右上のContactからお気軽にご連絡ください。(返事がない場合は見逃している可能性があるのでXやLinkedInからご連絡ください)",
