            ...
            <div className="flex flex-row justify-center pb-4">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  className="transform w-8 h-8 hover:fill-sky-500 hover:scale-125"
                >
                  ...
                  <div className="p-4 m-1">
                    ...
                    <div className="flex justify-start">
                      <a
                        ...
                        rel="noopener noreferrer"
                      >
                        <button className="border-2 hover:border-sky-500 hover:text-sky-500 px-4 py-2 rounded">
                          READ MORE
                        </button>
                      </a>
                    </div>
              ...
              <ul className="list-disc px-10 pb-20">
                <li>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <span className="hover:text-sky-500 py-1">
